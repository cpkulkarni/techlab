...
with open('motor_maintenance_complete.py', 'w') as f:
    f.write(complete_script)

print("=" * 80)
print("📄 COMPLETE PYTHON SCRIPT CREATED")
print("=" * 80)
print("\n✓ File: 'motor_maintenance_complete.py'")
print("\nThis standalone script includes:")
print("  • Synthetic data generation function")
print("  • Feature engineering function")
print("  • Prediction function")
print("  • Complete training pipeline")
print("  • Model saving and loading")
print("\nTo run: python motor_maintenance_complete.py")
print()
